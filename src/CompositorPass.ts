...
import VolumetricCompositorFragmentShader from './compositor.frag';
import VolumetricCompositorVertexShader from './compositor.vert';
...
export class VolumetricCompositorMaterial extends THREE.ShaderMaterial implements Resizable {
  constructor({ fogTexture, params, camera }: VolumetricCompositorMaterialProps) {
    const uniforms = {
      ...
      edgeStrength: {
        value: params?.edgeStrength ?? DefaultVolumetricPassCompositorParams.edgeStrength,
      },
  ...
  public updateUniforms(
    ...
    this.uniforms.edgeRadius.value =
      params?.edgeRadius ?? DefaultVolumetricPassCompositorParams.edgeRadius;
...
export class VolumetricCompositorPass extends Pass {
  ...
  override render(
    ...
    const sceneDepth = (this.fullscreenMaterial as VolumetricCompositorMaterial).uniforms.sceneDepth
      .value;
